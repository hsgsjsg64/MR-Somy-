...
expiry_time = datetime.strptime('''2024-3-1 00:00:00.000''', '''%Y-%m-%d %H:%M:%S.%f''')
if current_time > expiry_time:
    print('''خطيه وقفت الاداه راسلني علمود افعله VIP_TOP_2@''')
    exit(0)
...
try:
 ...
 print()
os.system('clear')
output = render('AYHM', colors=['white', 'blue'], align='center')
print(output)
print('@VIP_TOP_2')
...
token =('6708288291:AAGNLbXxG1PWefms2OVBO3HUe-_tchQjbBk') 
print('\n')
ID =('6021711003') 
...
try:
    prox= requests.get('https://github.com/OMAR-MOD-388/Facebook/blob/main/VipProxys.py').text
...
''')
    print('\033[1;31m[+]'*20)
    print(M+'1- FROM ID (FRIEND)')
    print(S+'2- FROM FILE ')
    print(F+'3- MAKE FILE ')
    print(B+'0- EDITE COOKIES ')
...
#!/usr/bin/python3
    ...
    class login():
    	...
    	def lo_epa(self):
    		system('clear')
    		print('عليك تسجيل الدخول بحساب فيسبوك شغال')
    ...
    def main_menu():
    	...
    	print(' جاري تشغيل الاداة انتضر قليلا ')
    	xo = '1'
    	if xo in ['01','1', 'A', 'a']:
...
def setting():
    ...
    passwrd()
def passwrd():
    with tred(max_workers=44) as pool:
        for yuzong in id2:
...
BY : @VIP_TOP_2 
CH : @VIP_TOP_2
#decoded by Hussien haider @VIP_TOP_2
                    '''
                    print(cp1)
